...
/**
 * Static demo of the clinical panel — the "prova de conceito" shown on the public
 * marketing pages (Médicos, Dashboard). Fictional data only. The live, data-backed
 * panel used inside the authenticated app is `PainelClinico`.
 */
...
export function PainelClinicoDemo() {
  return (
